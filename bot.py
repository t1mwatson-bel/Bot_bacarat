...
HEADERS = {
    ...
    "Referer": "https://1xlite-65155.pro/ru/live/twentyone/2092323-21-classics",
...
def get_active_games():
    ...
    try:
        url = "https://1xlite-65155.pro/service-api/main-live-feed/v3/games1x2?cfView=3&count=40&fcountry=1&gr=415&grMode=4&lng=ru&ref=7&selectedMs=1.146.2092323,2.146.2092323,10.146.2092323"
...
def get_game_data(game_id):
    ...
    url = f"https://1xlite-65155.pro/service-api/LiveFeed/GetGameZip?id={game_id}&isSubGames=true&GroupEvents=true&countevents=250&grMode=4&partner=7&topGroups=&country=190&marketType=1&isNewBuilder=true"
    try:
