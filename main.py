...
# ======== НАСТРОЙКИ ========
TOKEN = os.environ.get('5482422004:AAHXLYyZ-qoCsycse1k9Qt6YRi9jmB24B-k')
INPUT_CHANNEL_ID = int(os.environ.get('-1003855079501'))
OUTPUT_CHANNEL_ID = int(os.environ.get('-1003855079501'))
